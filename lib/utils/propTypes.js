...
exports.views =
  exports.dateRangeFormat =
  exports.dateFormat =
  exports.accessor =
  exports.DayLayoutAlgorithmPropType =
    void 0
...
var views = _propTypes.default.oneOfType([
  ...
  _propTypes.default.objectOf(function (prop, key) {
    ...
    if (isBuiltinView) {
      ...
      return _propTypes.default.elementType.apply(
        _propTypes.default,
...
var DayLayoutAlgorithmPropType = _propTypes.default.oneOfType([
  _propTypes.default.oneOf(['overlap', 'no-overlap']),
  _propTypes.default.func,
])
